...
/**
 * Strings for component 'qtype_graph', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    qtype
 * @subpackage graph
...
$string['graphtypes']='Graph types';
$string['pluginname_link'] = 'question/type/graph';
$string['pluginnameadding'] = 'Adding a graph question';
$string['pluginnameediting'] = 'Editing a graph question';
$string['pluginnamesummary'] = 'A graph question type which allows the embedding of the response fields for various available
